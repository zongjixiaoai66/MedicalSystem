 ...
 */
public class JiuzhenpingjiaVO  implements Serializable {
	...
	public void setTaidupingfen(String taidupingfen) {
		this.taidupingfen = taidupingfen;
	}
	
	/**
	 * 获取：态度评分
	 */
	public String getTaidupingfen() {
		return taidupingfen;
	}
