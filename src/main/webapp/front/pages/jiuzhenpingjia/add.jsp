				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.shijianduan" type="text" name="shijianduan" id="shijianduan" autocomplete="off" class="layui-input">
                                                                                ...
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">态度评分</label>
                        <div class="layui-input-block">
                            <select name="taidupingfen" id="taidupingfen" lay-filter="taidupingfen">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in taidupingfen" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">技术评分</label>
                        <div class="layui-input-block">
                            <select name="jishupingfen" id="jishupingfen" lay-filter="jishupingfen">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in jishupingfen" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                                                                            <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																																																								...
                																																																								vue.taidupingfen = '1,2,3,4,5'.split(',')
																vue.jishupingfen = '1,2,3,4,5'.split(',')
																								laydate.render({
					elem: '#pingjiariqi'
				});
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('jiuzhenpingjia' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
