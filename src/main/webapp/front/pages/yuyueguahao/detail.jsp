				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('yuyueguahao','病历')" @click="onAcrossTap('menzhenbingli')" type="button" class="layui-btn">
								病历
							</button>
																					<button v-if="isAuth('yuyueguahao','评价')" @click="onAcrossTap('jiuzhenpingjia')" type="button" class="layui-btn">
								评价
							</button>
