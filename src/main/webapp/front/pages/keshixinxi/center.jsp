				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="keshijieshao" id="keshijieshao" placeholder="科室介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">科室位置</label>
							<div class="layui-input-block">
								<input type="text" name="keshiweizhi" id="keshiweizhi" placeholder="科室位置" autocomplete="off" class="layui-input">
							</div>
						</div>
