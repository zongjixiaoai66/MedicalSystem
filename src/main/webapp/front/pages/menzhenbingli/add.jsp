		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.shijianduan" type="text" name="shijianduan" id="shijianduan" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">主诉：</label>
						<div class="layui-input-block">
							<input v-model="detail.zhusu" type="text" name="zhusu" id="zhusu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">现病史：</label>
						<div class="layui-input-block">
							<input v-model="detail.xianbingshi" type="text" name="xianbingshi" id="xianbingshi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">既往史：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiwangshi" type="text" name="jiwangshi" id="jiwangshi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">药敏史：</label>
						<div class="layui-input-block">
							<input v-model="detail.yaominshi" type="text" name="yaominshi" id="yaominshi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">诊断：</label>
						<div class="layui-input-block">
							<input v-model="detail.zhenduan" type="text" name="zhenduan" id="zhenduan" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">医嘱：</label>
						<div class="layui-input-block">
							<input v-model="detail.yizhu" type="text" name="yizhu" id="yizhu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('menzhenbingli' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
