				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="zhusu" id="zhusu" placeholder="主诉" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">现病史</label>
							<div class="layui-input-block">
								<input type="text" name="xianbingshi" id="xianbingshi" placeholder="现病史" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">既往史</label>
							<div class="layui-input-block">
								<input type="text" name="jiwangshi" id="jiwangshi" placeholder="既往史" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">药敏史</label>
							<div class="layui-input-block">
								<input type="text" name="yaominshi" id="yaominshi" placeholder="药敏史" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">诊断</label>
							<div class="layui-input-block">
								<input type="text" name="zhenduan" id="zhenduan" placeholder="诊断" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">治疗方案</label>
							<div class="layui-input-block">
								<input type="text" name="zhiliaofangan" id="zhiliaofangan" placeholder="治疗方案" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
