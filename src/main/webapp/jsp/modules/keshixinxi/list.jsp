...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>科室介绍</th>
											<th onclick="sort('keshiweizhi')">科室位置<i id="keshiweizhiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var keshijieshaoCell  = document.createElement('td');

						  if(item.keshijieshao != null && item.keshijieshao != "" && item.keshijieshao.length >= 11){
			  	keshijieshaoCell.innerHTML = item.keshijieshao.substring(0, 10) + "..."; 
			  }else{
			  	keshijieshaoCell.innerHTML = item.keshijieshao;
			  }


			row.appendChild(keshijieshaoCell);
			var keshiweizhiCell  = document.createElement('td');

						 keshiweizhiCell.innerHTML = item.keshiweizhi;


			row.appendChild(keshiweizhiCell);
