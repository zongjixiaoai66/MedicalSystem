...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">门诊病历管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>门诊病历列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">门诊病历列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zhusu')">主诉<i id="zhusuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xianbingshi')">现病史<i id="xianbingshiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jiwangshi')">既往史<i id="jiwangshiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('yaominshi')">药敏史<i id="yaominshiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zhenduan')">诊断<i id="zhenduanIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zhusuCell  = document.createElement('td');

						 zhusuCell.innerHTML = item.zhusu;


			row.appendChild(zhusuCell);
			var xianbingshiCell  = document.createElement('td');

						 xianbingshiCell.innerHTML = item.xianbingshi;


			row.appendChild(xianbingshiCell);
			var jiwangshiCell  = document.createElement('td');

						 jiwangshiCell.innerHTML = item.jiwangshi;


			row.appendChild(jiwangshiCell);
			var yaominshiCell  = document.createElement('td');

						 yaominshiCell.innerHTML = item.yaominshi;


			row.appendChild(yaominshiCell);
			var zhenduanCell  = document.createElement('td');

						 zhenduanCell.innerHTML = item.zhenduan;


			row.appendChild(zhenduanCell);
			var zhiliaofanganCell  = document.createElement('td');

						  if(item.zhiliaofangan != null && item.zhiliaofangan != "" && item.zhiliaofangan.length >= 11){
			  	zhiliaofanganCell.innerHTML = item.zhiliaofangan.substring(0, 10) + "..."; 
			  }else{
			  	zhiliaofanganCell.innerHTML = item.zhiliaofangan;
			  }


			row.appendChild(zhiliaofanganCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("menzhenbingli/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"menzhenbingli");
