...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">就诊评价管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>就诊评价列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">就诊评价列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="taidupingfen" id="taidupingfenSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('taidupingfen')">态度评分<i id="taidupingfenIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jishupingfen')">技术评分<i id="jishupingfenIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			var taidupingfenIndex = document.getElementById("taidupingfenSelect").selectedIndex;
			var taidupingfenOptions = document.getElementById("taidupingfenSelect").options;
			var taidupingfenSelectedOption = taidupingfenOptions[taidupingfenIndex]
			if(taidupingfenSelectedOption.text != null && taidupingfenSelectedOption.text != ''){
				searchForm.taidupingfen = "%" + taidupingfenSelectedOption.text + "%";
			}
        ...
        function getDataList() {
			http("jiuzhenpingjia/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				yishengxingming : searchForm.yishengxingming,	
				taidupingfen : searchForm.taidupingfen,	
		...
		function setDataRow(item,number){
			...
			var taidupingfenCell  = document.createElement('td');

						  taidupingfenCell.innerHTML = item.taidupingfen; 

			row.appendChild(taidupingfenCell);
			var jishupingfenCell  = document.createElement('td');

						  jishupingfenCell.innerHTML = item.jishupingfen; 

			row.appendChild(jishupingfenCell);
		...
		function sh(){
			...
			httpJson("jiuzhenpingjia/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiuzhenpingjia/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiuzhenpingjia");
