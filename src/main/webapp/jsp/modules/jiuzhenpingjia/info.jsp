						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="taidupingfen" name="taidupingfen" class="form-control" v-model="ruleForm.taidupingfen" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>技术评分</label>

									<input id="jishupingfen" name="jishupingfen" class="form-control" v-model="ruleForm.jishupingfen" readonly>
									</div>
