						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shanzhang" name="shanzhang" class="form-control" v-model="ruleForm.shanzhang" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>出诊时间</label>
									...
									<input id="keyuerenshu" name="keyuerenshu" class="form-control" v-model="ruleForm.keyuerenshu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>挂号费</label>
